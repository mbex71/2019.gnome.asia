                ...
                <div className="container-fluid">
                    ...
                    <Collapse isOpen={this.state.iscolapse} navbar>
                        ...
                        <Nav className="ml-auto" navbar>
                            <NavItem><Link className="nav-link" onClick={()=>this.props.setLoc('home')} style={this.props.location==='home' ? {fontWeight:'bold',opacity:1}:null} to="/">{String.navigation.home}</Link></NavItem>
                            <NavItem><Link className="nav-link" onClick={()=>this.props.setLoc('venue')} style={this.props.location==='venue' ? {fontWeight:'bold',opacity:1}:null} to="/venue">{String.navigation.venue}</Link></NavItem>
                            <NavItem><Link className="nav-link" onClick={()=>this.props.setLoc('registration')} style={this.props.location==='registration' ? {fontWeight:'bold',opacity:1}:null} to="/registration">{String.navigation.registration}</Link></NavItem>
                            <NavItem><Link className="nav-link" onClick={()=>this.props.setLoc('agenda')} style={this.props.location==='agenda' ? {fontWeight:'bold',opacity:1}:null} to="/agenda">{String.navigation.agenda}</Link></NavItem>
                            <NavItem><Link className="nav-link" onClick={()=>this.props.setLoc('staff')} style={this.props.location==='staff' ? {fontWeight:'bold',opacity:1}:null} to="/staff">{String.navigation.staff}</Link></NavItem>
